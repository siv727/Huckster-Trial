...
class ProductActivity(private val context: Context, private val productName: String) {

    fun showDialog() {
        val dialogView = LayoutInflater.from(context).inflate(R.layout.activity_product, null)
